...
$categoriesQuery = "SELECT DISTINCT category FROM machines";
...
// Fetch machines with category filter
try {
    ...
    echo "<div class='alert alert-danger'>Error loading machines: " . $e->getMessage() . "</div>";
}
?>
...
<head>
    ...
    <title>Machines - Association Management</title>
...
<!-- Hero Section -->
<section class="hero-machines bg-primary text-white py-5 text-center">
    <div class="container">
        <h1 class="display-4 fw-bold mb-4">Explore Our Machines</h1>
        <p class="lead mb-0">Browse our extensive collection of medical machines</p>
    </div>
</section>

<!-- Machines Grid -->
<section id="machines" class="py-5">
    <div class="container">
        <div class="row mb-4">
            <div class="col-md-6">
                <h2 class="mb-0">Available Machines</h2>
            </div>
            <div class="col-md-6">
        ...
        <div class="row g-4" id="machinesGrid">
